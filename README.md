# 👋 Salut, moi c’est Carmel AWANDE

## 🚀 Data Scientist / Data Analyst / Statisticien

🎓 Etudiant en Master 2 Traitement de l'Information et Data-science en Entreprise (TIDE) à l’Université Paris 1 Panthéon-Sorbonne, master classé Top 8 des meilleurs masters en France dans la catégorie Big Data & Data Sciences. Je suis passionné par la statistique, le Machine Learning, l’analyse de données et la modélisation.
...
|---|---|---|
| Master 2 Économétrie, Statistiques parcours Traitement de l'Information et Data-science en Entreprise (TIDE) | Université Paris 1 Panthéon-Sorbonne, Paris | Septembre 2026 → Aujourd'hui |
| Master 1 Mathématiques et applications parcours Data Science | Université d'Angers, Angers | Septembre 2025 → Mai 2026 |
...
![SAS](https://img.shields.io/badge/SAS-1E6BB8?style=for-the-badge&logo=sas&logoColor=white)
...
* Identifier les variables influençant les prix
...
## ⚡ Prévision de production d’électricité (ARIMA & LSTM)

📌 Prévision des séries temporelles de production mensuelle d’électricité aux États-Unis.
...
* Comparer les approches statistiques et Deep Learning
...
📌 Développement d’un jeu en Python basé sur les concepts de programmation orientée objet.
...
⭐ N’hésitez pas à explorer mes projets et à me contacter pour échanger autour de la Data Science, du Machine Learning et de l’analyse de données.
